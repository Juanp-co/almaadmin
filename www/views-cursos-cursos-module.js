...
const routes = [
    ...
    {
        path: 'crear',
        loadChildren: () => Promise.all(/*! import() | crear-crear-module */[__webpack_require__.e("default~crear-crear-module~modal-editar-contenido-modal-editar-contenido-module~modal-editar-tema-mo~00916f1d"), __webpack_require__.e("crear-crear-module")]).then(__webpack_require__.bind(null, /*! ./crear/crear.module */ "PDbM")).then(m => m.CrearPageModule)
    },
    {
        path: ':id',
        loadChildren: () => Promise.all(/*! import() | detalles-curso-detalles-curso-module */[__webpack_require__.e("default~detalles-curso-detalles-curso-module~views-eventos-eventos-module"), __webpack_require__.e("detalles-curso-detalles-curso-module")]).then(__webpack_require__.bind(null, /*! ./detalles-curso/detalles-curso.module */ "v0qv")).then(m => m.DetallesCursoPageModule)
    },
];
