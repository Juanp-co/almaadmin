...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header>\r\n  <ion-toolbar>\r\n    <ion-title>Asignar miembro</ion-title>\r\n    <ion-buttons slot=\"end\">\r\n      <ion-button color=\"primary\" (click)=\"confirmSaveNewMembers()\" [disabled]=\"!selectedUser\">\r\n        <ion-icon name=\"save-outline\" slot=\"start\"></ion-icon>\r\n        <ion-text>Guardar</ion-text>\r\n      </ion-button>\r\n      <ion-button (click)=\"closeModal()\">\r\n        <ion-icon name=\"close-outline\" slot=\"start\"></ion-icon>\r\n        <ion-text>Cancelar</ion-text>\r\n      </ion-button>\r\n    </ion-buttons>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content>\r\n  <ion-row>\r\n    <ion-col size=\"12\">\r\n      <ion-row>\r\n        <ion-col [size]=\"12\" size-sm=\"7\">\r\n          <ion-toolbar>\r\n            <ion-button color=\"medium\" (click)=\"queryParams.search = null; findData()\" slot=\"start\" *ngIf=\"queryParams.search\">\r\n              <ion-icon name=\"backspace-outline\"></ion-icon>\r\n            </ion-button>\r\n            <ion-item>\r\n              <ion-label position=\"floating\" color=\"medium\">Buscar</ion-label>\r\n              <ion-input\r\n                [(ngModel)]=\"queryParams.search\"\r\n                autocomplete=\"off\"\r\n                class=\"ion-text-uppercase\"\r\n              ></ion-input>\r\n            </ion-item>\r\n            <ion-button color=\"medium\" (click)=\"queryParams.search !== null || queryParams.search !== '' ? findData() : null\" slot=\"end\">\r\n              <ion-icon name=\"search-outline\"></ion-icon>\r\n            </ion-button>\r\n          </ion-toolbar>\r\n        </ion-col>\r\n      </ion-row>\r\n    </ion-col>\r\n  </ion-row>\r\n\r\n  <ion-row *ngIf=\"users && users.length > 0\">\r\n    <ion-col size=\"12\" size-sm=\"6\" *ngFor=\"let u of users\">\r\n      <app-user-group-card\r\n        [user]=\"u\"\r\n        [handleAdd]=\"handleAdd\"\r\n        [handleRemove]=\"handleRemove\"\r\n        [added]=\"checkAdded(u._id)\"\r\n      ></app-user-group-card>\r\n    </ion-col>\r\n  </ion-row>\r\n\r\n  <ion-row *ngIf=\"users.length === 0\">\r\n    <ion-col>\r\n      <ion-card>\r\n        <ion-card-content class=\"ion-text-center\">\r\n          <ion-text>\r\n            <p class=\"ion-text-center\">\r\n              <ion-icon name=\"alert-circle-outline\"></ion-icon>\r\n              No se encontraron resultados.\r\n            </p>\r\n          </ion-text>\r\n        </ion-card-content>\r\n      </ion-card>\r\n    </ion-col>\r\n  </ion-row>\r\n</ion-content>\r\n");
