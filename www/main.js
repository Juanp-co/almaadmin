...
module.exports = __webpack_require__(/*! C:\Users\velantcode\Documents\projects\alma\almaadmin\src\main.ts */"zUnb");
...
let GlobalService = class GlobalService {
    constructor(alertCtrl, loadingCtrl, modalController, router, cookieService) {
    ...
    checkRoles(roles = [], limits = [0, 1]) {
        return (roles === null || roles === void 0 ? void 0 : roles.some(r => limits.includes(r))) || false;
    }
    clearAllData() {
    ...
    altResponse(res) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            yield this.presentAlert('Alerta', (res === null || res === void 0 ? void 0 : res.error) || 'Error desconocido.');
            return null;
        });
    }
    errorSession() {
...
const routes = [
    ...
    {
        path: 'inicio',
        loadChildren: () => Promise.all(/*! import() | views-inicio-inicio-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-inicio-inicio-module")]).then(__webpack_require__.bind(null, /*! ./views/inicio/inicio.module */ "Wtct")).then(m => m.InicioPageModule)
    },
    {
        path: 'familias',
        loadChildren: () => Promise.all(/*! import() | views-familias-familias-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-familias-familias-module")]).then(__webpack_require__.bind(null, /*! ./views/familias/familias.module */ "c9Jc")).then(m => m.FamiliasPageModule)
    },
    {
        path: 'eventos',
        loadChildren: () => Promise.all(/*! import() | views-eventos-eventos-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-eventos-eventos-module")]).then(__webpack_require__.bind(null, /*! ./views/eventos/eventos.module */ "TjVE")).then(m => m.EventosPageModule)
    },
    {
        path: 'cursos',
        loadChildren: () => Promise.all(/*! import() | views-cursos-cursos-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-cursos-cursos-module")]).then(__webpack_require__.bind(null, /*! ./views/cursos/cursos.module */ "8C+O")).then(m => m.CursosPageModule)
    },
    {
        path: 'ofrendas',
    ...
    {
        path: 'miembros',
        loadChildren: () => Promise.all(/*! import() | views-miembros-miembros-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("common"), __webpack_require__.e("views-miembros-miembros-module")]).then(__webpack_require__.bind(null, /*! ./views/miembros/miembros.module */ "PI0l")).then(m => m.MiembrosPageModule)
    },
    {
        path: 'ingresar',
    ...
    },
    {
        ...
        loadChildren: () => Promise.all(/*! import() | views-cuentas-bancarias-cuentas-bancarias-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-cuentas-bancarias-cuentas-bancarias-module")]).then(__webpack_require__.bind(null, /*! ./views/cuentas-bancarias/cuentas-bancarias.module */ "Y16Y")).then(m => m.CuentasBancariasPageModule)
    },
    {
        path: 'mi-cuenta',
        loadChildren: () => Promise.all(/*! import() | views-mi-cuenta-mi-cuenta-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-mi-cuenta-mi-cuenta-module")]).then(__webpack_require__.bind(null, /*! ./views/mi-cuenta/mi-cuenta.module */ "1LWO")).then(m => m.MiCuentaPageModule)
    },
    {
        path: 'grupos-familiares',
        loadChildren: () => Promise.all(/*! import() | views-grupos-familiares-grupos-familiares-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-grupos-familiares-grupos-familiares-module")]).then(__webpack_require__.bind(null, /*! ./views/grupos-familiares/grupos-familiares.module */ "DOPO")).then(m => m.GruposFamiliaresPageModule)
    },
    {
        path: 'consolidados',
        loadChildren: () => Promise.all(/*! import() | views-consolidados-consolidados-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-consolidados-consolidados-module")]).then(__webpack_require__.bind(null, /*! ./views/consolidados/consolidados.module */ "V5HN")).then(m => m.ConsolidadosPageModule)
    },
    {
        path: 'ajustes',
        loadChildren: () => Promise.all(/*! import() | views-ajustes-ajustes-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-ajustes-ajustes-module")]).then(__webpack_require__.bind(null, /*! ./views/ajustes/ajustes.module */ "tY4H")).then(m => m.AjustesPageModule)
    },
    {
        path: 'devocionales',
        loadChildren: () => Promise.all(/*! import() | views-devocionales-devocionales-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-devocionales-devocionales-module")]).then(__webpack_require__.bind(null, /*! ./views/devocionales/devocionales.module */ "vOhD")).then(m => m.DevocionalesPageModule)
    },
    {
        path: 'iglesias',
        loadChildren: () => Promise.all(/*! import() | views-iglesias-iglesias-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-iglesias-iglesias-module")]).then(__webpack_require__.bind(null, /*! ./views/iglesias/iglesias.module */ "l/Mk")).then(m => m.IglesiasPageModule)
    },
    {
        path: 'documentos',
        loadChildren: () => Promise.all(/*! import() | views-documentos-documentos-module */[__webpack_require__.e("default~views-ajustes-ajustes-module~views-consolidados-consolidados-module~views-cuentas-bancarias-~2fe2a00d"), __webpack_require__.e("views-documentos-documentos-module")]).then(__webpack_require__.bind(null, /*! ./views/documentos/documentos.module */ "sZOn")).then(m => m.DocumentosPageModule)
    },
];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".fondoCool {\n  background-image: linear-gradient(to right bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(\"/assets/cruz.png\");\n  background-size: cover;\n  background-position: center center;\n  height: 150px;\n}\n\n.logo {\n  margin-bottom: -140px !important;\n  z-index: 1 !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
