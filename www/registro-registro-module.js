...
let RegistroPage = class RegistroPage {
    constructor(axios, globalSer, navCtrl, detallesMiembroService, miembrosService, router) {
        this.axios = axios;
    ...
    registerMember() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            const res = yield this.miembrosService.registerUser(Object.assign({}, this.formData));
            if (res && !res.error) {
