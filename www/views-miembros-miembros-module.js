...
let DetallesMiembroService = class DetallesMiembroService {
    ...
    resetPass(id, data) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const res = yield this.axios.putData(`/admin/users/${id}/reset-password`, data);
            if (res && res.success)
                return res.data.msg || 'Se han cambiado la contraseña del miembro exitosamente.';
            return this.globalSer.altResponse(res);
        });
    }
    setAsConsolidator(id) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const res = yield this.axios.putData(`admin/users/${id}/consolidator`);
            if (res && res.success)
                return res.data.msg;
            return this.globalSer.altResponse(res);
        });
    ...
    getData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            if (data && !data.error) {
                ...
                this.users = [];
                this.pages = 0;
                yield this.globalSer.presentAlert('Alerta', (data === null || data === void 0 ? void 0 : data.error) || '¡Error desconocido!');
            }
        });
    }
    downloadData() {
