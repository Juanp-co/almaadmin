...
const routes = [
    ...
    {
        path: 'registro',
        loadChildren: () => Promise.all(/*! import() | registro-registro-module */[__webpack_require__.e("default~detalles-miembro-detalles-miembro-module~registro-registro-module~views-mi-cuenta-mi-cuenta-module"), __webpack_require__.e("common"), __webpack_require__.e("registro-registro-module")]).then(__webpack_require__.bind(null, /*! ./registro/registro.module */ "3V3w")).then(m => m.RegistroPageModule)
    },
    {
        path: ':userid',
        loadChildren: () => Promise.all(/*! import() | detalles-miembro-detalles-miembro-module */[__webpack_require__.e("default~detalles-miembro-detalles-miembro-module~registro-registro-module~views-mi-cuenta-mi-cuenta-module"), __webpack_require__.e("common"), __webpack_require__.e("detalles-miembro-detalles-miembro-module")]).then(__webpack_require__.bind(null, /*! ./detalles-miembro/detalles-miembro.module */ "ZMlI")).then(m => m.DetallesMiembroPageModule)
    },
    {
