...
/* harmony import */ var _Utils_validations_functions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../Utils/validations.functions */ "OmbT");
...
let GruposService = class GruposService {
    ...
    // validate
    validateDataGroup(formData) {
        if (!Object(_Utils_validations_functions__WEBPACK_IMPORTED_MODULE_4__["checkIfValueIsNumber"])(`${formData.sector}`))
            return 'Disculpe, pero debe indicar número del sector.';
        if (!Object(_Utils_validations_functions__WEBPACK_IMPORTED_MODULE_4__["checkIfValueIsNumber"])(`${formData.subSector}`))
            return 'Disculpe, pero debe indicar el número del sub-sector.';
        if (!Object(_Utils_validations_functions__WEBPACK_IMPORTED_MODULE_4__["checkIfValueIsNumber"])(`${formData.number}`))
            return 'Disculpe, pero debe indicar el número del grupo.';
        if (!Object(_Utils_validations_functions__WEBPACK_IMPORTED_MODULE_4__["checkTitlesOrDescriptions"])(formData.direction))
            return 'Disculpe, pero debe indicar una dirección.';
        return null;
    }
};
