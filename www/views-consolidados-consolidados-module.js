    ...
    ngOnInit() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!this.data)
                ...
                this.data.date = dayjs__WEBPACK_IMPORTED_MODULE_5___default()(this.data.date, 'YYYY-MM-DD', true).locale('es').format('dddd, DD [de] MMMM [de] YYYY');
        });
    }
    closeModal() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
        ...
        if (data && data.length > 0) {
            ...
            data.forEach(c => {
                this.consolidatesPreview.push({
                    ...
                    date: dayjs__WEBPACK_IMPORTED_MODULE_5___default()(c.date, 'YYYY-MM-DD', true).locale('es').format('dddd, DD [de] MMMM [de] YYYY'),
                });
            });
        }
    }
