...
let DetallesEventoPage = class DetallesEventoPage {
    ...
    setDataToParams(data) {
        ...
        this.eventData.date = dayjs__WEBPACK_IMPORTED_MODULE_6___default()(initFormat, 'YYYY-MM-DD HH:mm', true)
            .locale('es')
            .format(data.dateEnd ? formatDateRet : formatDateWithOutHoursRet);
        this.eventData.dateEnd = dayjs__WEBPACK_IMPORTED_MODULE_6___default()(endFormat, 'YYYY-MM-DD HH:mm', true)
            .locale('es')
            .format(formatDateRet);
        this.eventData.initHour = dayjs__WEBPACK_IMPORTED_MODULE_6___default()(initFormat, 'YYYY-MM-DD HH:mm', true).format('hh:mm a');
        this.eventData.endHour = data.endHour ?
            dayjs__WEBPACK_IMPORTED_MODULE_6___default()(`${data.dateEnd || data.date} ${data.endHour}`, 'YYYY-MM-DD HH:mm', true).format('hh:mm a')
            : null;
